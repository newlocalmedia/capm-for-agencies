...
""",
        ...
        "reading_path": 'This Theory page is best after the <a href="../tldr/price-the-work-before-you-plan-it.html">TL;DR</a> or <a href="../tldr/walkthrough.html">Walkthrough</a>. Next read the <a href="../tldr/decision-guide.html">Decision Guide</a> → <a href="../index.html">Decision Cards</a>. Smaller agencies that want a guided version first can open <a href="../project-risk-check/index.html">Project Risk Check</a>. The <a href="../tldr/calibration-notes.html">Calibration Notes</a> document is a deeper dive into the current implementation.',
        "reading_path_html": True,
        "actions": [
            ("Open the Decision Cards", "../index.html", "primary"),
            ("Project Risk Check", "../project-risk-check/index.html", "secondary"),
...
""",
        ...
        "reading_path": 'This TL;DR is the best first read for most people. Next read the <a href="../tldr/walkthrough.html">Walkthrough</a> → <a href="../tldr/decision-guide.html">Decision Guide</a> → <a href="../index.html">Decision Cards</a>. Smaller agencies that want a guided version first can open <a href="../project-risk-check/index.html">Project Risk Check</a>. The <a href="../tldr/calibration-notes.html">Calibration Notes</a> and <a href="../theory/index.html">Theory</a> documents are deeper dives into CAPM and how it\'s used here.',
        "reading_path_html": True,
        "actions": [
            ("Open the Decision Cards", "../index.html", "primary"),
            ("Project Risk Check", "../project-risk-check/index.html", "secondary"),
...
""",
        ...
        "reading_path": 'This Walkthrough is best after the <a href="./price-the-work-before-you-plan-it.html">TL;DR</a>. Next read the <a href="./decision-guide.html">Decision Guide</a> → <a href="../index.html">Decision Cards</a>. Smaller agencies that want a guided version first can open <a href="../project-risk-check/index.html">Project Risk Check</a>. The <a href="./calibration-notes.html">Calibration Notes</a> and <a href="../theory/index.html">Theory</a> documents are deeper dives into CAPM and how it\'s used here.',
        "reading_path_html": True,
        "actions": [
            ("Open the Decision Cards", "../index.html", "primary"),
            ("Project Risk Check", "../project-risk-check/index.html", "secondary"),
